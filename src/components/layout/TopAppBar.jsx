...
export default function TopAppBar({ points = "1,250" }) {
  return (
    <header className="bg-white/90 backdrop-blur-xl sticky top-0 flex justify-between items-center w-full px-5 pt-9 pb-3 z-50 border-b border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.02)]">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button className="relative w-8 h-8 flex items-center justify-center text-gray-500 bg-gray-50 rounded-full border border-gray-100 transition-colors hover:bg-gray-100">
