...
export default function PhoneFrame({ children }) {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-gray-200 py-4 overflow-hidden">
      <div className="h-[90vh] max-h-[740px] aspect-[390/844] bg-background rounded-[2.5rem] shadow-2xl border-8 border-gray-900 overflow-hidden relative flex flex-col transform-gpu">
